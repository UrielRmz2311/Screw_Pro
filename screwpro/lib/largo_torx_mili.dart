...
import 'info_torx_mili.dart'; // Asegúrate de importar la vista correspondiente

class LargoTorxMiliScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Largo Torx Milimetrico'),
        actions: <Widget>[
          TextButton(
            onPressed: () {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (buttonText == '18 mm') { // Ajuste aquí sin las comillas adicionales
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => InfoTorxMiliScreen()),
                              );
                            }
                          },
                          style: ElevatedButton.styleFrom(
