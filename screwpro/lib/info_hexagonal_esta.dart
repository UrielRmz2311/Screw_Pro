...
class InfoHexagonalEstaScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Informacion Hexagonal Estandar'),
        actions: <Widget>[
          TextButton(
            onPressed: () {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 248, 255, 42), // Color del botón rojo
